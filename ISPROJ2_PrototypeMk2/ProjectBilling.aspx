...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ="<%$ ConnectionStrings:ISPROJ2ConnectionString %>" SelectCommand="SELECT [proj_code], [proj_title], CONVERT(DATE,[proj_endDate], 120), [Personnel].[emp_fname] + ' ' + [Personnel].[emp_lname], [proj_actualEnd] FROM [Project] INNER JOIN [Personnel] ON [Personnel].[emp_user_id] = [Project].[proj_leader] WHERE ([status] = @status)">
            <SelectParameters>
