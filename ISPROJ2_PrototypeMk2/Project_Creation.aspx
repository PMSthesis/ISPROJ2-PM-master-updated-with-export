...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CHOCOBOSQLEXPRESS %>" SelectCommand="SELECT [client_id], [client_name] FROM [Client]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CHOCOBOSQLEXPRESS %>" SelectCommand="SELECT [emp_user_id], [emp_fname] + ' '  + [emp_lname] FROM [Personnel] WHERE ([emp_position] = @emp_position)">
            <SelectParameters>
                <asp:Parameter DefaultValue="5" Name="emp_position" />
            </SelectParameters>
        </asp:SqlDataSource>
    
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:CHOCOBOSQLEXPRESS %>" SelectCommand="SELECT [emp_user_id] AS 'ID', [emp_fname]+' '+[emp_lname] AS 'FULL NAME' FROM [Personnel] WHERE ([emp_position] = @emp_position)">
            <SelectParameters>
...
&nbsp;<br />
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:CHOCOBOSQLEXPRESS %>" SelectCommand="SELECT [stock_code], [stock_id] FROM [Stock]"></asp:SqlDataSource>
